...
jest.mock('react-native-paper', () => {
  ...
  MockAvatar.Image = React.forwardRef(
    ({ source, size, style, ...props }, ref) => {
  ...
  MockAvatar.Text = React.forwardRef(
    ({ label, size, style, ...props }, ref) => {
      return React.createElement(
        'View',
        {
          ref,
        ...
        React.createElement('Text', { testID: 'avatar-text-label' }, label),
      );
    },
  );

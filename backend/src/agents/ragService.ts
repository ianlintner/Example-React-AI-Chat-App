...
export class RAGService {
  ...
  private initializeContent(): void {
    ...
    this.contentDatabase.push(
      ...
      },
      {
        id: 'joke_008',
        type: 'joke',
        content: "A man walks into a library and asks for books on paranoia. The librarian whispers, 'They're right behind you!'",
        category: 'story_joke',
      ...
      // Trivia Facts
      {
        id: 'trivia_001',
        type: 'trivia',
        content: "Did you know that octopuses have three hearts and blue blood? Two hearts pump blood to the gills, while the third pumps blood to the rest of the body!",
        category: 'animals',
      ...
      },
      {
        id: 'trivia_002',
        type: 'trivia',
        content: "Here's a mind-blowing fact: Honey never spoils! Archaeologists have found pots of honey in ancient Egyptian tombs that are over 3,000 years old and still perfectly edible!",
        category: 'food',
      ...
      },
      {
        id: 'trivia_003',
        type: 'trivia',
        content: "Amazing fact: A single cloud can weigh over a million pounds! That's equivalent to about 100 elephants floating in the sky!",
        category: 'weather',
      ...
      },
      {
        id: 'trivia_004',
        type: 'trivia',
        content: "Fascinating: Bananas are berries, but strawberries aren't! Botanically speaking, a berry must have seeds inside its flesh.",
        category: 'botany',
        tags: ['bananas', 'berries', 'strawberries', 'botany', 'classification'],
        rating: 4
      },
      {
        id: 'trivia_005',
        type: 'trivia',
        content: "Cool fact: The human brain uses about 20% of the body's total energy, despite being only 2% of body weight!",
        category: 'human_body',
      ...
      },
      {
        id: 'trivia_006',
        type: 'trivia',
        content: "Incredible: There are more possible games of chess than there are atoms in the observable universe! The number of possible chess games is estimated to be around 10^120.",
      ...
      },
      {
        id: 'trivia_007',
        type: 'trivia',
        content: "Did you know that dolphins have names for each other? They use unique whistle signatures to identify and call to specific individuals in their pod!",
        category: 'animals',
      ...
      },
      {
        id: 'trivia_008',
        type: 'trivia',
        content: "Amazing space fact: A day on Venus is longer than its year! Venus takes 243 Earth days to rotate once but only 225 Earth days to orbit the Sun.",
        category: 'space',
      ...
      },
      {
        id: 'trivia_009',
        type: 'trivia',
        content: "Fascinating history: The Great Wall of China isn't visible from space with the naked eye, despite the popular myth. This misconception has been debunked by astronauts!",
        category: 'history',
      ...
      },
      {
        id: 'trivia_010',
        type: 'trivia',
        content: "Cool biology fact: Sharks have been around for more than 400 million years, making them older than trees! They've survived four of the 'big five' mass extinctions.",
        category: 'animals',
      ...
      // GIF URLs (from popular services)
      {
        ...
        rating: 4,
        metadata: { description: 'Funny laughing reaction', alt: 'Person laughing hysterically' }
      },
      {
        id: 'gif_002',
        type: 'gif',
        ...
        rating: 4,
        metadata: { description: 'Excited celebration dance', alt: 'Person dancing with excitement' }
      },
      {
        id: 'gif_003',
        type: 'gif',
        ...
        rating: 5,
        metadata: { description: 'Cute animal being adorable', alt: 'Cute animal gif' }
      },
      {
        id: 'gif_004',
        type: 'gif',
        ...
        category: 'applause',
        tags: ['applause', 'clapping', 'approval', 'well done', 'congratulations'],
        rating: 4,
        metadata: { description: 'Applause and clapping', alt: 'Person clapping enthusiastically' }
      },
      {
        id: 'gif_005',
        type: 'gif',
        ...
        rating: 4,
        metadata: { description: 'Thumbs up approval', alt: 'Person giving thumbs up' }
      },
      {
        id: 'gif_006',
        type: 'gif',
        ...
        rating: 4,
        metadata: { description: 'Surprised reaction', alt: 'Person looking surprised' }
      },
      {
        id: 'gif_007',
        type: 'gif',
        ...
        rating: 4,
        metadata: { description: 'Party celebration', alt: 'Party celebration with dancing' }
      },
      {
        id: 'gif_008',
        type: 'gif',
        ...
        rating: 4,
        metadata: { description: 'Facepalm reaction', alt: 'Person doing a facepalm' }
      },
      {
        id: 'gif_009',
        type: 'gif',
        ...
        rating: 4,
        metadata: { description: 'Shrugging gesture', alt: 'Person shrugging shoulders' }
      },
      {
        id: 'gif_010',
        type: 'gif',
        ...
        rating: 5,
        metadata: { description: 'Mind blown reaction', alt: 'Person with mind blown expression' }
      }
    );

    console.log(`📚 RAG Service initialized with ${this.contentDatabase.length} content items`);
  }
  ...
  private calculateRelevanceScore(query: string, item: ContentItem): number {
    ...
    for (const word of queryWords) {
      ...
      // Check category
      if (item.category?.toLowerCase().includes(word) || word.includes(item.category?.toLowerCase() || '')) {
        score += 0.2;
      }
  ...
  search(query: SearchQuery): SearchResult[] {
    ...
    console.log(`🔍 RAG Search: "${query.text}" found ${results.length} results`);
    return results;
  }
  ...
  addContent(item: ContentItem): void {
    ...
    const existing = this.contentDatabase.find(existing => 
      existing.content === item.content || existing.id === item.id
    );
  ...
  getTopRated(type?: 'joke' | 'trivia' | 'gif', limit: number = 5): ContentItem[] {
  ...
  searchForAgent(agentType: AgentType, query: string, fallbackToRandom: boolean = true): ContentItem | null {
